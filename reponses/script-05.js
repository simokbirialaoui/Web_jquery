...
$("#ce table tbody tr").each(function (i) {
  // Parcourt chaque ligne du tableau dans l'élément avec l'ID 'ce'
  if (i !== 0 && i !== $("#ce table tbody tr").length - 1) {
    // Vérifie si l'index de la ligne n'est ni 0 ni la dernière ligne
